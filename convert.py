...
# Temporary folder, don't delete it, don't fuck with it
TEMP_FOLDER = 'tmp'
    ...
    if filename.endswith('.mp4'):
        ...
        (
            ...
            .output(output_filename,
                    ...
                    af=f"volume={rand_values['volume']},atempo={rand_values['speed']}")
        ...
        if random_song:
            ...
            temp_audio_file = os.path.join(TEMP_FOLDER, "temp_trimmed_audio4_{filename}.mp3")
